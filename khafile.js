...
project.addAssets("/home/tong/sdk/ArmorySDK/lib/haxerecast/js/recast/recast.js", { notinlist: true });
...
project.addParameter('arm.node.Game');
project.addParameter("--macro keep('arm.node.Game')");
...
project.addParameter('arm.node.MainmenuAnimation');
project.addParameter("--macro keep('arm.node.MainmenuAnimation')");
...
project.addAssets("/home/tong/sdk/ArmorySDK/armory/Assets/noise256.png", { notinlist: true });
...
project.addAssets("Bundled/font/helvetica_neue_85.ttf", { notinlist: false });
project.addAssets("Bundled/font/mono.ttf", { notinlist: false });
project.addAssets("Bundled/index.html", { notinlist: true });
project.addAssets("Bundled/sickness.json", { notinlist: true });
project.addAssets("Bundled/sound/boot.wav", { notinlist: true , quality: 0.8999999761581421});
project.addAssets("Bundled/sound/horn.wav", { notinlist: true , quality: 0.8999999761581421});
project.addAssets("Bundled/sound/mainmenu_ambient.wav", { notinlist: true , quality: 0.8999999761581421});
project.addAssets("Bundled/sound/patient_pick.wav", { notinlist: true , quality: 0.8999999761581421});
project.addAssets("Bundled/sound/patient_release.wav", { notinlist: true , quality: 0.8999999761581421});
project.addAssets("Bundled/sound/traffic.wav", { notinlist: true , quality: 0.8999999761581421});
